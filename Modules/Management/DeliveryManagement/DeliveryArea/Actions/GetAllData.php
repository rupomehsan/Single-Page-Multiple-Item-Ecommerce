...
class GetAllData
{
    ...
    $q->where('area_name', 'like', '%' . $searchKey . '%');    

    $q->orWhere('division', 'like', '%' . $searchKey . '%');    

    $q->orWhere('district', 'like', '%' . $searchKey . '%');    

    $q->orWhere('thana', 'like', '%' . $searchKey . '%');    

    $q->orWhere('delivery_days', 'like', '%' . $searchKey . '%');    

    $q->orWhere('delivery_charge', 'like', '%' . $searchKey . '%');    

    $q->orWhere('is_available', 'like', '%' . $searchKey . '%');    

    $q->orWhere('cod_available', 'like', '%' . $searchKey . '%');              
