/**
 * Banner Store - Factory Pattern Implementation
 *
...
// Create the Banner store with all CRUD functionality
export const banner_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = banner_store;

// Default export for Composition API usage
export default banner_store;
