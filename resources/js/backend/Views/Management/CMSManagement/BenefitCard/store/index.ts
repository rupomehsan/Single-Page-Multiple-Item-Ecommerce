/**
 * BenefitCard Store - Factory Pattern Implementation
 *
...
// Create the BenefitCard store with all CRUD functionality
export const benefit_card_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = benefit_card_store;

// Default export for Composition API usage
export default benefit_card_store;
