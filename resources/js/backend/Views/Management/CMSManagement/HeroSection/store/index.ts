/**
 * HeroSection Store - Factory Pattern Implementation
 *
...
// Create the HeroSection store with all CRUD functionality
export const hero_section_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = hero_section_store;

// Default export for Composition API usage
export default hero_section_store;
