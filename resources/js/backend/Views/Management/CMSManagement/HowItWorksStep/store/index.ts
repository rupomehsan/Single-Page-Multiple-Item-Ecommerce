/**
 * HowItWorksStep Store - Factory Pattern Implementation
 *
 ...
 * @package HowItWorksStep
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the HowItWorksStep store with all CRUD functionality
export const how_it_works_step_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = how_it_works_step_store;

// Default export for Composition API usage
export default how_it_works_step_store;
