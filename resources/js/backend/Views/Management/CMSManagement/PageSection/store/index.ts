/**
 * PageSection Store - Factory Pattern Implementation
 *
...
// Create the PageSection store with all CRUD functionality
export const page_section_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = page_section_store;

// Default export for Composition API usage
export default page_section_store;
