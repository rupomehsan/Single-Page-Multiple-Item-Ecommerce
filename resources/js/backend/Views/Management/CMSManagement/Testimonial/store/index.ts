/**
 * Testimonial Store - Factory Pattern Implementation
 *
...
// Create the Testimonial store with all CRUD functionality
export const testimonial_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = testimonial_store;

// Default export for Composition API usage
export default testimonial_store;
