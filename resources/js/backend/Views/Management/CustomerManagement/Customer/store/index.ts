/**
 * Customer Store - Factory Pattern Implementation
 *
...
// Create the Customer store with all CRUD functionality
export const customer_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = customer_store;
