/**
 * DeliveryArea Store - Factory Pattern Implementation
 *
...
// Create the DeliveryArea store with all CRUD functionality
export const delivery_area_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = delivery_area_store;

// Default export for Composition API usage
export default delivery_area_store;
