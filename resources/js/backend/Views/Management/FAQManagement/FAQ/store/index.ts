/**
 * FAQ Store - Factory Pattern Implementation
 *
...
// Create the FAQ store with all CRUD functionality
export const f_a_q_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = f_a_q_store;

// Default export for Composition API usage
export default f_a_q_store;
