/**
 * Order Store - Factory Pattern Implementation
 *
...
// Create the Order store with all CRUD functionality
export const order_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = order_store;
