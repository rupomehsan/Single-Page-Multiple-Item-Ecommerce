/**
 * Product Store - Factory Pattern Implementation
 *
...
// Create the Product store with all CRUD functionality
export const product_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = product_store;
