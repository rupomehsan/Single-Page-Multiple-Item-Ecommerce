/**
 * ProductCategory Store - Factory Pattern Implementation
 *
...
// Create the ProductCategory store with all CRUD functionality
export const product_category_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = product_category_store;

// Default export for Composition API usage
export default product_category_store;
