/**
 * PromoCode Store - Factory Pattern Implementation
 *
...
// Create the PromoCode store with all CRUD functionality
export const promo_code_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = promo_code_store;

// Default export for Composition API usage
export default promo_code_store;
