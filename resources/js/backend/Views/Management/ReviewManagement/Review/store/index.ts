/**
 * Review Store - Factory Pattern Implementation
 *
...
// Create the Review store with all CRUD functionality
export const review_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = review_store;
