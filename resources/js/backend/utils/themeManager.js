...
class ThemeManager {
  ...
  setTheme(theme) {
    ...
    // Suppress all CSS transitions/animations during the swap so the new theme
    // applies instantly instead of fading in over 300ms.
    ...
    // Force layout flush so the class changes are painted before transitions return
    void body.offsetHeight;

    // Re-enable transitions on the next frame so subsequent hover/focus still animates
